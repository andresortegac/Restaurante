    ...
    public function open(Request $request, Box $box): RedirectResponse|Response
    {
        ...
        DB::transaction(function () use ($box, $validated): void {
            ...
            if ($lockedBox->activeSession()->exists()) {
                abort(422, 'La caja seleccionada ya tiene una sesion abierta.');
            }
            ...
            if ($userHasOpenSession) {
                abort(422, 'Ya tienes una caja abierta y debes cerrarla antes de abrir otra.');
            }

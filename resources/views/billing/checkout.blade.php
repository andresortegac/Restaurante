                        ...
                        <form method="POST" action="{{ route('billing.checkout.store', $order) }}" id="billingCheckoutForm" accept-charset="UTF-8">
                            ...
                            <div class="meta-box mb-3">
                                ...
                                <div class="d-flex justify-content-between gap-3 mt-2">
                                    ...
                                    <strong id="checkoutAppliedBalance">$0</strong>
                                </div>
                                <div class="d-flex justify-content-between gap-3 mt-2">
        ...
        if (shouldApplyCustomerBalance() && !selectedCustomer()) {
            if (window.Swal) {
                await Swal.fire({
                    ...
                    text: 'Selecciona un cliente antes de usar saldo a favor.',
                    confirmButtonText: 'Aceptar',
                    confirmButtonColor: '#2563eb',
                });
            } else {
                alert('Selecciona un cliente antes de usar saldo a favor.');
            }

    ...
    <div style="display: flex;">
        ...
        <aside class="sidebar" id="sidebar">
            ...
            <ul class="sidebar-menu">
                ...
                @if(Auth::user()->hasPermission(['users.view', 'users.create', 'users.edit', 'users.delete']))
                <li>
                ...
                @if(Auth::user()->hasPermission(['roles.view', 'permissions.view']))
                <li>
                    <a href="#" data-toggle-menu>
                ...
                @if(Auth::user()->hasPermission(['orders.view', 'orders.create']))
                <li>
                    <a href="#" data-toggle-menu>
                ...
                @if(Auth::user()->hasPermission(['tables.view', 'tables.manage']))
                <li>
                    <a href="#" data-toggle-menu>
                ...
                @if(Auth::user()->hasPermission(['inventory.view', 'inventory.manage']))
                <li>
                    <a href="#" data-toggle-menu>
